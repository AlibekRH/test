...
if (isset($result->bank)) {
    ...
    $get_users_sql = mysqli_query($conn, "select * from users where user_uid = '$user_uid'");
    $get_users = mysqli_fetch_assoc($get_users_sql);
    ...
    $sql = $conn->query("INSERT INTO transaction (type, uid, appointment_id, card_id, merchant_id, amount, reference, bank_sign, date)
VALUES ('enquiry', '$uid', '', '$card_id', '$merchant_id', '$amount', '$reference', '$bank_sign', '$today')");
