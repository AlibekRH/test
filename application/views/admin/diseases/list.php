            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Diseases List</h3>
                        <a href="<?php echo base_url() . 'AddDiseases'; ?>" class="btn btn-success pull-right">Add Diseases</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped datatable">
                                ...
                                <tbody>
                                    <?php
                                    if ($diseases_details) {
                                        foreach ($diseases_details as $key => $row) {
                                            ?>
                                            <tr>
                                                <td><?php echo $key + 1; ?></td>
                                                <td><?php echo $row->diseases_name; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url() . 'UpdateDiseases/' . $row->id; ?>" title="Edit" class="btn btn-success">
