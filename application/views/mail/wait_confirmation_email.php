                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr><td>
                                                <div style="line-height: 24px;">
                                                    ...
                                                    <span style="width:94% !important; font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #57697e; float: left; margin-left: 3%; margin-top:3%;margin-bottom:4%; width:100%;"><?php echo $message; ?></span>
                                                    </font>
                                                </div>
                                                <!-- padding --><div style="height: 15px; line-height: 40px; font-size: 10px;"></div>
                                            </td></tr>
                                        <tr><td><font>
                                                <span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #57697e; float: left; margin-left: 3%; margin-top:3%;margin-bottom:4%;"><?php echo $faithfully; ?>, <br> <?php echo $team; ?></span>
                                                </font>
                                            </td></tr>
                                    </table>		
                            </td></tr>
