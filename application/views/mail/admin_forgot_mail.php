                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr><td>
                                                <div style="line-height: 24px;">
                                                    ...
                                                    <h3 style="font-size: 18px; color: #373737; float: left; margin-left: 3%; margin-top:5%;">Hello,</h3>
                                                    <span style="width:94% !important; font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #57697e; float: left; margin-left: 3%; margin-top:3%;margin-bottom:4%; width:100%;">This is your temprary password Please Login and changed it: <?php echo $password; ?></span>
                                                    </font>
                                                </div>
