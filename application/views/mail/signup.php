                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr><td>
                                                <div style="line-height: 24px;">
                                                    ...
                                                    <span style="width:94% !important; font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #57697e; float: left; margin-left: 3%; margin-top:3%;margin-bottom:4%; width:100%;"><?php echo $verification_content; ?> </span>
                                                    </font>
                                                </div>
                                        ...
                                        <tr><td>
                                                <div style="line-height: 24px;">
                                                    <center>
                                                        <a href="<?php echo $link; ?>" style="text-decoration: none;"><button style="padding: 8px 20px 8px 20px;font-size: 16px;border-radius: 8px;border: none;color: #fff;background: #2abf88;display:inherit;cursor:pointer;margin: 5% auto 0% auto;" type="button" class="btn btn-primary"><?php echo $Verify_Email; ?></button></a>
                                                    </center>
                                                </div>
